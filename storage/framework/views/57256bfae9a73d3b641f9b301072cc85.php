...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Golden Sky Hotel & Wellness'); ?></title>
    
    <!-- SEO Meta Tags -->
    <meta name="description" content="<?php echo $__env->yieldContent('description', 'Experience luxury and tranquility at Golden Sky Hotel & Wellness in Kandy, Sri Lanka. Book your stay at our premium hotel with world-class amenities, fine dining, and wellness center.'); ?>">
    ...
    <meta property="og:title" content="<?php echo $__env->yieldContent('title', 'Golden Sky Hotel & Wellness'); ?>">
    <meta property="og:description" content="<?php echo $__env->yieldContent('description', 'Experience luxury and tranquility at Golden Sky Hotel & Wellness in Kandy, Sri Lanka.'); ?>">
    <meta property="og:image" content="<?php echo e(asset('icon.png')); ?>">
    
    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="<?php echo e(url()->current()); ?>">
    <meta property="twitter:title" content="<?php echo $__env->yieldContent('title', 'Golden Sky Hotel & Wellness'); ?>">
    <meta property="twitter:description" content="<?php echo $__env->yieldContent('description', 'Experience luxury and tranquility at Golden Sky Hotel & Wellness in Kandy, Sri Lanka.'); ?>">
    <meta property="twitter:image" content="<?php echo e(asset('icon.png')); ?>">
...
<body class="bg-white antialiased">
    ...
    <div id="page-loader">
        <div class="loader-content">
            <img src="<?php echo e(asset('icon.png')); ?>" alt="Golden Sky Hotel" class="loader-logo">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="flex items-center">
                    <a href="<?php echo e(route('home')); ?>" class="flex items-center space-x-3 group">
                        <div class="relative">
                            ...
                            <img src="<?php echo e(asset('icon.png')); ?>" alt="Golden Sky Hotel" class="relative h-14 w-14 transform group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 drop-shadow-lg">
                        </div>
                        <div>
                ...
                <div class="flex items-center space-x-2">
                    <a href="<?php echo e(route('home')); ?>" class="text-white hover:text-gold px-4 py-2 text-sm font-bold transition-all duration-300 relative group drop-shadow-md">
                        <span>Home</span>
                    ...
                    <a href="<?php echo e(route('rooms.index')); ?>" class="text-white hover:text-gold px-4 py-2 text-sm font-bold transition-all duration-300 relative group drop-shadow-md">
                        <span>Rooms</span>
                        <div class="absolute bottom-0 left-0 right-0 h-0.5 bg-gold transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></div>
                    </a>
                    <a href="<?php echo e(route('spa.home')); ?>" target="_blank" rel="noopener noreferrer" class="text-white hover:text-gold px-4 py-2 text-sm font-bold transition-all duration-300 relative group drop-shadow-md">
                        <span>Spa</span>
                        <div class="absolute bottom-0 left-0 right-0 h-0.5 bg-gold transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></div>
                    </a>
                    <a href="<?php echo e(route('menu.index')); ?>" class="text-white hover:text-gold px-4 py-2 text-sm font-bold transition-all duration-300 relative group drop-shadow-md">
                        <span>Menu</span>
                        <div class="absolute bottom-0 left-0 right-0 h-0.5 bg-gold transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></div>
                    </a>
                        ...
                        <div class="relative" x-data="{ open: false }" @click.away="open = false">
                            <button @click="open = !open" class="flex items-center space-x-2 text-white hover:text-gold px-4 py-2 text-sm font-bold focus:outline-none transition-all duration-300 drop-shadow-md">
                                <div class="w-9 h-9 bg-gradient-to-br from-gold to-gold-dark rounded-full flex items-center justify-center shadow-lg border-2 border-white/50">
                                    <span class="text-sm font-bold text-white"><?php echo e(strtoupper(substr(explode(' ', auth()->user()->name)[0], 0, 1))); ?></span>
                                </div>
                            ...
                            <div x-show="open" 
                                ...
                                <div class="py-2">
                                    ...
                                    <div class="px-4 py-4 bg-gradient-to-r from-gold-dark to-gold">
                                        <p class="text-sm font-bold text-white"><?php echo e(auth()->user()->name); ?></p>
                                        <p class="text-xs text-white/80 mt-1"><?php echo e(auth()->user()->email); ?></p>
                                    </div>
                                    
                                    <!-- Menu Items -->
                                    <div class="px-2 py-2">
                                        <a href="<?php echo e(route('profile')); ?>" class="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gold-light hover:text-gray-900 rounded-lg transition duration-150">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="text-white hover:text-gold px-4 py-2 text-sm font-bold transition-all duration-300 relative group drop-shadow-md">
                            <span>Login</span>
                            <div class="absolute bottom-0 left-0 right-0 h-0.5 bg-gold transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></div>
                        </a>
                        <a href="<?php echo e(route('register')); ?>" class="bg-gradient-to-r from-gold to-gold-dark hover:from-gold-dark hover:to-gold text-white px-6 py-2.5 rounded-lg text-sm font-bold transition-all duration-300 transform hover:scale-105 shadow-xl border-2 border-white/30">
                            Register
                        </a>
                    <?php endif; ?>
                </div>
    ...
    <div id="errorModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" x-data="{ show: true }" x-show="show" x-cloak @click.away="show = false" @keydown.escape.window="show = false">
        <div class="bg-white rounded-xl shadow-2xl max-w-md w-full mx-4 transform transition-all" @click.stop x-show="show" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 scale-90" x-transition:enter-end="opacity-100 scale-100" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-90">
            ...
            <!-- Modal Body -->
            <div class="px-6 py-4">
                <p class="text-gray-800 text-base leading-relaxed"><?php echo e(session('error')); ?></p>
            </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.chatbot','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="col-span-1">
                    <div class="flex items-center space-x-2 mb-4">
                        <img src="<?php echo e(asset('icon.png')); ?>" alt="Golden Sky Hotel" class="h-10 w-10">
                ...
                <div class="col-span-1">
                    ...
                    <ul class="space-y-2">
                        <li><a href="<?php echo e(route('home')); ?>" class="text-white text-opacity-80 hover:text-white transition duration-300">Home</a></li>
                        <li><a href="<?php echo e(route('rooms.index')); ?>" class="text-white text-opacity-80 hover:text-white transition duration-300">Our Rooms</a></li>
                        <li><a href="<?php echo e(route('menu.index')); ?>" class="text-white text-opacity-80 hover:text-white transition duration-300">Restaurant Menu</a></li>
                        <?php if(auth()->guard()->check()): ?>
                            <li><a href="<?php echo e(route('profile')); ?>" class="text-white text-opacity-80 hover:text-white transition duration-300">My Profile</a></li>
                        <?php else: ?>
                            <li><a href="<?php echo e(route('login')); ?>" class="text-white text-opacity-80 hover:text-white transition duration-300">Login</a></li>
                            <li><a href="<?php echo e(route('register')); ?>" class="text-white text-opacity-80 hover:text-white transition duration-300">Register</a></li>
                        <?php endif; ?>
                    </ul>
                </div>
                ...
                <div class="col-span-1">
                    ...
                    <div class="mb-6">
                        <a href="<?php echo e(route('home')); ?>#reviews" class="inline-flex items-center space-x-2 bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-lg px-4 py-3 transition-all duration-300 border border-white/20 hover:border-white/40 group">
                            ...
                            <div class="text-left">
                                <div class="text-sm font-bold text-white"><?php echo e(config('reviews.overall_rating', 4.9)); ?> rating</div>
                                <div class="text-xs text-white/80"><?php echo e(config('reviews.total_reviews', 45)); ?> reviews</div>
                            </div>
            ...
            <div class="border-t border-yellow-600 border-opacity-30 mt-8 pt-8">
                <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                    <p class="text-sm text-white text-opacity-80">
                        <span id="copyright-symbol" class="cursor-pointer select-none">©</span> <?php echo e(date('Y')); ?> Golden Sky Hotel & Wellness. All rights reserved.
                    </p>
...
<?php /**PATH /Users/duminduthalwatta/Documents/Golden Sky with change /Golden Sky Hotel & Wellness/Golden Sky Hotel & Wellness/Web application/resources/views/layouts/app.blade.php ENDPATH**/ ?>