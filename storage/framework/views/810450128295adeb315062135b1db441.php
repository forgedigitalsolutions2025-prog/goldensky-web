<?php $__env->startSection('title', 'Menu - Golden Sky Hotel & Wellness'); ?>

<?php $__env->startSection('content'); ?>
<!-- Page Header -->
<div class="relative h-80 bg-cover bg-center bg-no-repeat" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('<?php echo e(asset('images/hotel/25d6bd5d-1d42-4f67-b177-7821da518a85.JPG')); ?>');">
            ...
            <div class="mb-16">
                ...
                <div class="text-center mb-10">
                    <h2 class="text-4xl font-bold text-gray-900 mb-2">
                        <?php echo e(ucwords(str_replace('_', ' ', $category))); ?>
                ...
                <div class="grid md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-x-4 gap-y-6">
                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 group">
                            ...
                            <div class="relative h-40 overflow-hidden bg-gray-100">
                                <?php if($imagePath): ?>
                                    <img src="<?php echo e(asset($imagePath)); ?>" 
                                         alt="<?php echo e($itemName); ?>" 
                                         class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
                                         onerror="this.onerror=null; this.src='<?php echo e(asset('images/hotel/25d6bd5d-1d42-4f67-b177-7821da518a85.JPG')); ?>';">
                                <?php else: ?>
                            ...
                            <div class="p-3">
                                <!-- Item Name -->
                                <h3 class="text-base font-bold text-gray-900 mb-1"><?php echo e($itemName); ?></h3>
                                
                                <!-- Description -->
                                <?php if($itemDescription): ?>
                                    <p class="text-xs text-gray-600 line-clamp-2"><?php echo e($itemDescription); ?></p>
                                <?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/duminduthalwatta/Documents/Forge Software Solutions/Golden Sky Hotel & Wellness/Web application/resources/views/menu/index.blade.php ENDPATH**/ ?>