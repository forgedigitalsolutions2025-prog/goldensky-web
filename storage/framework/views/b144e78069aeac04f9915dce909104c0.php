<?php $__env->startSection('title', 'Login - Golden Sky Hotel & Wellness'); ?>
...
<div class="relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div class="absolute inset-0 bg-cover bg-center animate-slow-zoom" 
         style="background-image: url('<?php echo e(asset('images/hotel/6fd9adaf-af07-47e8-99d6-f7e07a490dd7.JPG')); ?>');"></div>
    <div class="absolute inset-0 bg-gradient-to-br from-gold-dark/80 via-black/50 to-gold-dark/80"></div>
    
    <!-- Animated Glow -->
    <div class="absolute inset-0 opacity-20">
        <div class="absolute top-1/3 left-1/4 w-96 h-96 bg-gold rounded-full blur-3xl animate-pulse"></div>
        <div class="absolute bottom-1/3 right-1/4 w-96 h-96 bg-gold-light rounded-full blur-3xl animate-pulse" style="animation-delay: 1.5s;"></div>
    </div>
    ...
    <div class="relative z-10 max-w-sm w-full mx-4 animate-fade-in-up">
        <div class="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl p-8">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-3xl font-bold bg-gradient-to-r from-gold-dark to-gold bg-clip-text text-transparent mb-2">Welcome Back</h1>
                <p class="text-sm text-gray-600">Sign in to continue your journey</p>
            </div>

            <!-- Success/Error Messages -->
            <?php if(session('success')): ?>
                <div class="bg-green-50 border-l-4 border-green-500 text-green-700 p-4 mb-6 rounded-lg animate-fade-in" role="alert">
...
unset($__errorArgs, $__bag); ?>
                ...
                <!-- Remember Me -->
                <div class="flex items-center">
                    <input type="checkbox" name="remember" id="remember" class="rounded border-gray-300 text-gold focus:ring-gold h-5 w-5">
                    <label for="remember" class="ml-3 text-sm text-gray-600 cursor-pointer hover:text-gray-900">
                        Remember me for 30 days
                    </label>
                </div>

                <!-- Login Button -->
                <button type="submit" class="w-full bg-gradient-to-r from-gold to-gold-dark hover:from-gold-dark hover:to-gold text-white font-bold py-3 px-6 rounded-xl transition duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl flex items-center justify-center space-x-2">
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="text-gold-dark hover:text-gold font-bold underline decoration-2 underline-offset-2 hover:decoration-gold transition">
                        Create one now
                    </a>
                </p>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/duminduthalwatta/Documents/Forge Software Solutions/Golden Sky Hotel & Wellness/Web application/resources/views/auth/login.blade.php ENDPATH**/ ?>