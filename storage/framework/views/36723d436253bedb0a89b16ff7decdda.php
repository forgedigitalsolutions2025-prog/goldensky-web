<?php $__env->startSection('title', 'Rooms - Golden Sky Hotel & Wellness'); ?>

<?php $__env->startSection('content'); ?>
<!-- Page Header -->
<div class="relative h-80 bg-cover bg-center bg-no-repeat" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('<?php echo e(asset('images/hotel/18565ed7-9a8a-4e5d-8080-a615ec89f74e.JPG')); ?>');">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <form action="<?php echo e(route('rooms.index')); ?>" method="GET">
                    <div class="grid md:grid-cols-4 gap-6">
                        ...
                        <div>
                            ...
                            <input type="date" id="check_in_date" name="check_in" value="<?php echo e($checkIn); ?>" 
                        ...
                        <div>
                            ...
                            <input type="date" id="check_out_date" name="check_out" value="<?php echo e($checkOut); ?>" 
                                   min="<?php echo e($checkIn ? date('Y-m-d', strtotime($checkIn . ' +1 day')) : date('Y-m-d', strtotime('+1 day'))); ?>" 
                                   class="w-full border-2 border-gray-300 rounded-xl px-5 py-4 text-base focus:ring-2 focus:ring-gold focus:border-gold transition hover:border-gold-dark shadow-sm hover:shadow-md">
                        </div>
                        ...
                        <div class="flex items-end space-x-3">
                            ...
                            <a href="<?php echo e(route('rooms.index')); ?>" class="flex-none bg-white hover:bg-gray-50 text-gray-700 hover:text-gold-dark font-bold p-4 rounded-xl transition-all duration-300 border-2 border-gray-300 hover:border-gold shadow-lg hover:shadow-xl transform hover:scale-105 group">
        ...
        <?php if($rooms->isNotEmpty()): ?>
            <div class="mb-6 text-center">
                <p class="text-gray-600">Found <span class="font-bold text-gold-dark"><?php echo e($rooms->count()); ?></span> rooms available
                <?php if($checkIn && $checkOut): ?>
                    from <span class="font-semibold"><?php echo e(\Carbon\Carbon::parse($checkIn)->format('M d, Y')); ?></span> to <span class="font-semibold"><?php echo e(\Carbon\Carbon::parse($checkOut)->format('M d, Y')); ?></span>
                <?php endif; ?>
                </p>
            </div>
        <?php endif; ?>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <?php $__empty_1 = true; $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 group">
                    ...
                    <div class="p-6">
                        <!-- Room Type & Number -->
                        <div class="mb-3">
                            <h3 class="text-2xl font-bold text-gray-900 mb-1"><?php echo e($roomType); ?></h3>
                            <p class="text-sm text-gray-500">Room <?php echo e($room['roomNumber'] ?? ''); ?></p>
                        </div>
                        ...
                        <div class="flex items-center space-x-4 mb-4 text-sm text-gray-600">
                            <div class="flex items-center">
                                ...
                                <span><?php echo e($room['maxOccupancy'] ?? 0); ?> Guests</span>
                            </div>
                            <div class="flex items-center">
                                <svg class="w-5 h-5 mr-1 text-gold-dark" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
                                </svg>
                                <span><?php echo e(ucfirst(strtolower($roomType))); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            <div class="flex flex-wrap gap-2">
                                <?php $__currentLoopData = array_slice($amenities, 0, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $amenity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class="bg-gold-light text-gold-dark text-xs px-2 py-1 rounded-full"><?php echo e($amenity); ?></span>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php if(count($amenities) > 3): ?>
                                    <span class="bg-gray-100 text-gray-600 text-xs px-2 py-1 rounded-full">+<?php echo e(count($amenities) - 3); ?> more</span>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="border-t pt-4 mb-4">
                            <div class="flex items-baseline justify-between">
                                <div>
                                    <span class="text-3xl font-bold text-gold-dark">LKR <?php echo e(number_format($room['pricePerNight'] ?? 0, 0)); ?></span>
                        ...
                        <div class="mb-4 flex items-center justify-center space-x-3 text-sm">
                            ...
                            <span class="text-gray-600 font-semibold"><?php echo e(config('reviews.overall_rating', 4.9)); ?></span>
                            <span class="text-gray-500">(<?php echo e(config('reviews.total_reviews', 45)); ?> reviews)</span>
                        </div>
                        
                        <!-- Action Buttons -->
                        <div class="flex space-x-2">
                            <a href="<?php echo e(route('rooms.show', $room['id'] ?? 0)); ?>" 
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                <a href="<?php echo e(route('bookings.create', ['room_id' => $room['id'] ?? 0, 'check_in' => $checkIn, 'check_out' => $checkOut])); ?>" 
                            ...
                            <?php else: ?>
                                <a href="<?php echo e(route('login', ['redirect' => route('bookings.create', ['room_id' => $room['id'] ?? 0, 'check_in' => $checkIn, 'check_out' => $checkOut])])); ?>" 
                                   class="flex-1 bg-gold hover:bg-gold-dark text-white text-center font-semibold py-3 px-4 rounded-lg transition duration-300 transform hover:scale-105">
                                    Book Now
                                </a>
                            <?php endif; ?>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="col-span-full text-center py-16">
                    ...
                    <a href="<?php echo e(route('rooms.index')); ?>" class="inline-block bg-gold hover:bg-gold-dark text-white font-semibold py-3 px-8 rounded-lg transition duration-300">
                        View All Rooms
                    </a>
                </div>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/duminduthalwatta/Documents/Forge Software Solutions/Golden Sky Hotel & Wellness/Web application/resources/views/rooms/index.blade.php ENDPATH**/ ?>