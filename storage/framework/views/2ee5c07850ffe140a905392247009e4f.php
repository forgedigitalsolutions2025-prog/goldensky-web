<?php $__env->startSection('title', 'About Us - Shadhara Wellness'); ?>
    ...
    <div class="container">
        <div class="about-content-full">
            <div class="about-image">
                <img src="<?php echo e(asset('spa-assets/images/about/about.jpg')); ?>" alt="Shadhara Wellness" loading="lazy">
            </div>
...
<section class="doctors-section">
    <div class="container">
        ...
        <div class="doctors-list">
            ...
            <div class="doctor-profile fade-in-up <?php echo e($index < count($doctors) - 1 ? 'has-divider' : ''); ?>">
                <div class="doctor-image-wrapper">
                    ...
                    <div class="doctor-image-circle">
                        <?php if($doctor->image): ?>
                            <img src="<?php echo e(asset('spa-assets/images/doctors/' . $doctor->image)); ?>" alt="<?php echo e($doctor->name); ?>" loading="lazy" onerror="this.onerror=null; this.src='<?php echo e(asset('spa-assets/images/doctors/default-doctor.jpg')); ?>';">
                        <?php else: ?>
                ...
                <div class="doctor-info">
                    <h3 class="doctor-name"><?php echo e($doctor->name); ?></h3>
                    <?php if($doctor->title): ?>
                    <p class="doctor-title"><?php echo e($doctor->title); ?></p>
                    <?php endif; ?>
                    <?php if($doctor->bio): ?>
                    <p class="doctor-bio"><?php echo e($doctor->bio); ?></p>
                    <?php else: ?>
                        <?php if($doctor->qualifications): ?>
                        <p class="doctor-qualifications"><?php echo e($doctor->qualifications); ?></p>
                        <?php endif; ?>
                        <?php if($doctor->specialization): ?>
                        <p class="doctor-specialization"><?php echo e($doctor->specialization); ?></p>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            </div>
...
<?php echo $__env->make('spa::layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/duminduthalwatta/Documents/Forge Software Solutions/Golden Sky Hotel & Wellness/Web application/sharadha wellness/resources/views/about.blade.php ENDPATH**/ ?>