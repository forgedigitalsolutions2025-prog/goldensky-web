...
<body class="bg-gray-100">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    <a href="<?php echo e(route('admin.inventory-requests')); ?>" class="text-white hover:underline text-sm font-medium">Inventory Requests</a>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <!-- Period Selector -->
        <div class="mb-6">
            <form method="GET" action="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center space-x-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 border-l-4 border-green-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900 mt-2">LKR <?php echo e(number_format($metrics['room_revenue'], 2)); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 border-l-4 border-red-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900 mt-2">LKR <?php echo e(number_format($metrics['total_expenses'] ?? 0, 2)); ?></p>
                    </div>
            ...
            ?>
            <div class="bg-white rounded-lg shadow-lg p-6 border-l-4 <?php echo e($isProfit ? 'border-green-500' : 'border-red-500'); ?>">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-gray-600 text-sm font-semibold uppercase">Net Profit</p>
                        <p class="text-3xl font-bold <?php echo e($isProfit ? 'text-green-600' : 'text-red-600'); ?> mt-2">LKR <?php echo e(number_format($netProfit, 2)); ?></p>
                    </div>
                    <div class="<?php echo e($isProfit ? 'bg-green-100' : 'bg-red-100'); ?> p-3 rounded-full">
                        <svg class="w-8 h-8 <?php echo e($isProfit ? 'text-green-600' : 'text-red-600'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 border-l-4 border-blue-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($metrics['total_bookings']); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 border-l-4 border-yellow-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($metrics['occupancy_rate']); ?>%</p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 border-l-4 border-purple-500">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($metrics['available_rooms']); ?>/<?php echo e($metrics['total_rooms']); ?></p>
                    </div>
        ...
        <!-- Expenses Breakdown -->
        <?php if(isset($metrics['expenses_breakdown']) && ($metrics['total_expenses'] ?? 0) > 0): ?>
        <div class="bg-white rounded-lg shadow-lg p-6 mb-8">
            <h2 class="text-xl font-bold text-gray-800 mb-4">Expenses Breakdown</h2>
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <?php if($metrics['expenses_breakdown']['grn'] > 0): ?>
                <div class="bg-gray-50 rounded-lg p-4">
                    <p class="text-gray-600 text-sm font-semibold">Inventory (GRN)</p>
                    <p class="text-2xl font-bold text-gray-900 mt-2">LKR <?php echo e(number_format($metrics['expenses_breakdown']['grn'], 2)); ?></p>
                </div>
                <?php endif; ?>
                <?php if($metrics['expenses_breakdown']['staff_meals'] > 0): ?>
                <div class="bg-gray-50 rounded-lg p-4">
                    <p class="text-gray-600 text-sm font-semibold">Staff Meals</p>
                    <p class="text-2xl font-bold text-gray-900 mt-2">LKR <?php echo e(number_format($metrics['expenses_breakdown']['staff_meals'], 2)); ?></p>
                </div>
                <?php endif; ?>
                <?php if($metrics['expenses_breakdown']['salaries'] > 0): ?>
                <div class="bg-gray-50 rounded-lg p-4">
                    <p class="text-gray-600 text-sm font-semibold">Salaries</p>
                    <p class="text-2xl font-bold text-gray-900 mt-2">LKR <?php echo e(number_format($metrics['expenses_breakdown']['salaries'], 2)); ?></p>
                    <p class="text-xs text-gray-500 mt-1">Finalized on payment date</p>
                </div>
                <?php endif; ?>
                <?php if($metrics['expenses_breakdown']['other'] > 0): ?>
                <div class="bg-gray-50 rounded-lg p-4">
                    <p class="text-gray-600 text-sm font-semibold">Other Expenses</p>
                    <p class="text-2xl font-bold text-gray-900 mt-2">LKR <?php echo e(number_format($metrics['expenses_breakdown']['other'], 2)); ?></p>
                </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            <div class="bg-white rounded-lg shadow p-4">
                ...
                <p class="text-2xl font-bold text-blue-600"><?php echo e($metrics['active_bookings']); ?></p>
            </div>
            <div class="bg-white rounded-lg shadow p-4">
                <p class="text-gray-600 text-sm">Pending Bookings</p>
                <p class="text-2xl font-bold text-yellow-600"><?php echo e($metrics['pending_bookings']); ?></p>
            </div>
            <div class="bg-white rounded-lg shadow p-4">
                <p class="text-gray-600 text-sm">Completed</p>
                <p class="text-2xl font-bold text-green-600"><?php echo e($metrics['completed_bookings']); ?></p>
            </div>
            <div class="bg-white rounded-lg shadow p-4">
                <p class="text-gray-600 text-sm">Total Guests</p>
                <p class="text-2xl font-bold text-purple-600"><?php echo e($metrics['total_guests']); ?></p>
            </div>
        </div>

        <!-- Revenue Chart -->
        <?php if(count($charts['revenue']) > 0): ?>
        <div class="bg-white rounded-lg shadow-lg p-6 mb-8">
                        ...
                        <?php $__currentLoopData = $recentBookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                                    <?php echo e($booking['guest_name']); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                                    <?php echo e($booking['room_number']); ?> - <?php echo e($booking['room_type']); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                                    <span class="px-2 py-1 text-xs font-medium rounded bg-gray-100"><?php echo e($booking['source']); ?></span>
                                </td>
                            </tr>
    ...
    <script>
        ...
        const revenueData = <?php echo json_encode($charts['revenue'], 15, 512) ?>;
...
<?php /**PATH /Users/duminduthalwatta/Documents/Golden Sky with change /Golden Sky Hotel & Wellness/Golden Sky Hotel & Wellness/Web application/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>