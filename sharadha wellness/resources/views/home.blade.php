...
@section('title', 'Shadhara Wellness - Embracing Ancient Ceylon Healing')

@section('content')
<!-- Hero Sections -->
<section class="hero-slider">
    <div class="hero-slide active">
        <div class="hero-bg" style="background-image: url('{{ asset('spa-assets/images/hero/hero-1.png') }}');"></div>
        <div class="hero-content">
            <div class="container">
                <h1>Shadhara Wellness Begins with Nature's Touch and Care</h1>
                <a href="{{ route('spa.treatments') }}" class="btn-primary">Our Treatments</a>
            </div>
        </div>
    </div>
    <div class="hero-slide">
        <div class="hero-bg" style="background-image: url('{{ asset('spa-assets/images/hero/hero-2.png') }}');"></div>
        <div class="hero-content">
            <div class="container">
                <h1>Discover Inner Peace Through Herbal Spa and Wellness Rituals</h1>
                <a href="{{ route('spa.pricing') }}" class="btn-primary">Se price plans</a>
            </div>
        </div>
    </div>
    <div class="hero-slide">
        ...
        <div class="hero-content">
            <div class="container">
                ...
                <a href="{{ route('spa.contact') }}" class="btn-primary">Contact Us</a>
            </div>
        </div>
    </div>
        ...
        <div class="services-grid">
            ...
            <div class="service-card">
                <div class="service-image">
                    <img src="{{ asset('spa-assets/images/treatments/' . $treatment->image) }}" 
                         alt="{{ $treatment->name }}" 
                         loading="lazy"
                         onerror="this.onerror=null; this.src='{{ asset('spa-assets/images/treatments/treatments.jpg') }}';">
                </div>
    ...
    <div class="container">
        <div class="about-content">
            <div class="about-text fade-in-left">
                ...
                <a href="{{ route('spa.treatments') }}" class="btn-primary">See Our Treatements</a>
            </div>
        ...
        <div class="pricing-preview">
            <div class="pricing-card">
                ...
                <div class="pricing-card-footer">
                    ...
                    <a href="{{ route('spa.pricing') }}" class="btn-secondary">Book Now</a>
                </div>
            </div>
            <div class="pricing-card">
                <div class="pricing-card-header">
        ...
        <div class="package-features">
            <div class="package-feature">
                <div class="feature-icon">
                    <img src="{{ asset('spa-assets/images/decorations/flower-decoration.png') }}" alt="Icon" onerror="this.style.display='none'">
                </div>
            ...
            <div class="package-feature">
                <div class="feature-icon">
                    <img src="{{ asset('spa-assets/images/decorations/flower-16.png') }}" alt="Icon" onerror="this.style.display='none'">
                </div>
            ...
            <div class="package-feature">
                <div class="feature-icon">
                    <img src="{{ asset('spa-assets/images/decorations/flower-4.svg') }}" alt="Icon" onerror="this.style.display='none'">
                </div>
        ...
        <div class="appointment-content">
            ...
            <form action="{{ route('spa.booking.store') }}" method="POST" class="booking-form">
                ...
                <div class="treatment-tabs">
                    @foreach($treatments as $treatment)
                    <span class="treatment-tab" data-treatment="{{ $treatment->id }}">{{ $treatment->name }}</span>
                    @endforeach
                </div>
                <div class="form-row">
                    <div class="form-group">
        ...
        <div class="testimonials-slider">
            ...
            <div class="testimonial-card">
                <div class="testimonial-image">
                    <img src="{{ asset('spa-assets/images/testimonials/' . $testimonial->image) }}" alt="{{ $testimonial->name }}" onerror="this.src='{{ asset('spa-assets/images/testimonials/testimonial-1.jpg') }}'">
                </div>
                <div class="testimonial-content">
                    <p>"{{ $testimonial->testimonial }}"</p>
                    <h4>{{ $testimonial->name }}</h4>
                    <span>Customer {{ $testimonial->location ? 'from ' . $testimonial->location : '' }}</span>
                </div>
            </div>
            @endforeach
        </div>
