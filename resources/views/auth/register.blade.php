...
@section('title', 'Register - Golden Sky Hotel & Wellness')
...
<div class="relative min-h-screen flex items-center justify-center overflow-hidden py-12">
    ...
    <div class="absolute inset-0 bg-cover bg-center animate-slow-zoom" 
         style="background-image: url('{{ asset('images/hotel/770bc666-39a7-444c-b029-18bc1a37b2bb.JPG') }}');"></div>
        ...
        <div class="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl p-8">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required autofocus
                           class="w-full border-2 border-gray-300 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-gold focus:border-gold transition hover:border-gold-dark @error('name') border-red-500 @enderror"
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="{{ route('login') }}" class="text-gold-dark hover:text-gold font-bold underline decoration-2 underline-offset-2 hover:decoration-gold transition">
                        Sign in here
                    </a>
                </p>
            </div>
