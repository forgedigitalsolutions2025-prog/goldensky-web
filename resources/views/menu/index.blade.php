...
@section('content')
<!-- Page Header -->
<div class="relative h-56 sm:h-64 md:h-80 bg-cover bg-center bg-no-repeat" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('{{ asset('images/hotel/25d6bd5d-1d42-4f67-b177-7821da518a85.JPG') }}');">
    <div class="absolute inset-0 flex items-center justify-center">
        <div class="text-center text-white px-4">
            <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-2 md:mb-4">Restaurant Menu</h1>
            <p class="text-base sm:text-lg md:text-xl lg:text-2xl opacity-90">Discover our exquisite culinary offerings</p>
        </div>
    </div>
</div>
